...
<?php $heading_tag = ( is_home() || is_front_page() || is_archive() || is_search() ) ? 'h1' : 'div'; ?>
			<<?php echo $heading_tag; ?> id="logo">
				<a href="<?php echo home_url( '/' ); ?>" title="<?php bloginfo('name'); ?>" rel="home"><img alt="<?php bloginfo('name'); ?>" src="<?php bloginfo('template_url'); ?>/images/mylogo_250_70.png" /><?php bloginfo('name'); ?></a>
